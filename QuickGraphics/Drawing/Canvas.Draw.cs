...
partial class Canvas
{
    ...
    public void Circle(Style style, Point center, Number radius) => _drawer.Enqueue(Primitives.Circle, new Circle(style, center, radius));
    public void Ellipse(Style style, Point center, Number radiusX, Number radiusY) => _drawer.Enqueue(Primitives.Ellipse, new Ellipse(style, center, radiusX, radiusY));
